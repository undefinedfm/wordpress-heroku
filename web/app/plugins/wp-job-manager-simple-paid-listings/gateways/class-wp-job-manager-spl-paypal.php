...
class WP_Job_Manager_SPL_PayPal extends WP_Job_Manager_SPL_Gateway {
	...
	private function get_paypal_payment_link( $job_id ) {
		$paypal_args = apply_filters(
			'job_manager_spl_paypal_args', array(
				'cmd'           => '_cart',
